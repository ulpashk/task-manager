...
export const TagsPage = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 h-full flex flex-col overflow-hidden font-sans">
      ...
      <Modal isOpen={isDeleteOpen} onClose={() => setIsDeleteOpen(false)} title="Удалить тэг">
        <div className="p-4 flex flex-col gap-6">
          <p className="text-gray-600">Вы уверены, что хотите удалить тэг <b>{selectedTag?.name}</b>?</p>

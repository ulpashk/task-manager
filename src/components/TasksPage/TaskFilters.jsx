  ...
  return (
    <div className="p-6 pb-0 font-sans">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-bold text-gray-800 tracking-tight">{t('tasks.all_tasks')}</h3>
        <div className="flex items-center gap-3">
          ...
          <button onClick={onAddClick} className="bg-[#1677FF] text-white px-4 py-2 rounded-lg flex items-center gap-2 font-semibold hover:bg-blue-600 shadow-sm transition-all"><Plus size={20}/> {t('tasks.add')}</button>
        </div>
      </div>

      <div className="flex items-end gap-4 mb-6 flex-wrap">
        <div className="w-[180px]">
          <label className="text-xs font-medium text-gray-500 mb-1.5 block">{t('tasks.filter_assignee')}</label>
          <select
        ...
        <div className="w-[180px]">
          <label className="text-xs font-medium text-gray-500 mb-1.5 block">{t('tasks.filter_tag')}</label>
          <MultiSelectDropdown
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-gray-500">{t('tasks.filter_date_from')}</label>
          <input
            type="date"
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-xs font-medium text-gray-500">{t('tasks.filter_date_to')}</label>
          <input
            type="date"
        ...
        <div className="flex gap-2 ml-2">
          <button onClick={handleApplyClick} className="px-5 py-2 bg-[#F5F5F5] border border-gray-200 text-gray-400 hover:bg-blue-500 hover:text-white rounded-lg text-sm transition-all">{t('common.apply')}</button>
          <button onClick={handleResetClick} className="px-5 py-2 bg-[#F5F5F5] border border-gray-200 text-gray-400 hover:bg-gray-50 rounded-lg text-sm transition-all">{t('common.reset')}</button>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-4 pb-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-gray-500 font-medium">{t('common.rows')}</span>
